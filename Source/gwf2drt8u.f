     ...
     1                         IDCHANGEC   
        INTEGER, SAVE, DIMENSION (:), ALLOCATABLE :: IDCHNGTYP
...
C     ------------------------------------------------------------------
      ...
      ALLOCATE(NPDRT,IDRTPB,IDRTFL,NRFLOW,NOPRDT,IDCHANGEC)
C
...
C5C-----READ ITEM 3
     ...
     &                       IDRTFL,IUNSTR,NEQS,IDCHANGEC,IDCHNGTYP)
            LB = LB+NLST
   50     CONTINUE
  100   CONTINUE
      ENDIF
...
C     ******************************************************************
      ...
      DIMENSION DRTF(NDRTVL,MXDRT),IDCHNGTYP(MXDRT)
